...
public class PekerjaanFrame extends JFrame {
    ...
    public PekerjaanFrame(PekerjaanDao pekerjaanDao) {
        ...
        Font font = new Font("Arial", 2, 17);
        table.setFont(font);
        table.setRowHeight(20);

        // Keterangan!: Halaman ini untuk menambah kategori pekerjaan dalam apk biodata
        JLabel label = new JLabel("Mohon Isi Pekerjaan");
        ...
        buttonEdit.setBounds(245, 100, 100, 40);
